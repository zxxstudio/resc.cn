...
// 调试日志
console.log("Home.vue theme:", theme.value);
console.log("Home.vue postData length:", theme.value.postData?.length);
console.log("Home.vue postData:", theme.value.postData);
