...
- 名称：`小性工作室`
- 描述：`张小性的个人空间，记录想法、分享作品`
- 地址：`https://resc.cn/`
- 头像：`/images/logo/logo.webp`
- 站点图片：`/images/logo/logo.webp`
- 订阅：`https://resc.cn/rss.xml`

```yml
name: 小性工作室
desc: 张小性的个人空间，记录想法、分享作品
url: https://resc.cn/
avatar: /images/logo/logo.webp
screenshot: /images/logo/logo.webp
rss: https://resc.cn/rss.xml
```

### 申请友链

- 我已添加 [小性工作室](https://resc.cn/) 的友情链接。
